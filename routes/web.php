...
Route::get('/input-email',[BookController::class,'getinputEmail'])->name('getinputEmail');

Route::post('/input-email',[BookController::class,'postinputEmail'])->name('postinputEmail');
